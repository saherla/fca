...
<template>
  <div>
    ...
    <main>
      ...
      >
        <div class="bg absolute top-0 w-full h-full bg-center bg-cover">
          <span
            id="blackOverlay"
          ...
          <div class="flex flex-wrap">
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Titulo 1</h5>
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                />
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Titulo 2</h5>
                  <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
                    Specialist
                  </p>
                  <div class="mt-6">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                />
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Titulo 3</h5>
                  <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
                    UI/UX Designer
                  </p>
                  <div class="mt-6">
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                />
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Titulo 4</h5>
                  <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
                    Founder and CEO
                  </p>
                  <div class="mt-6">
